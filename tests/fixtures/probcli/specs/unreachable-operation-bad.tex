...
\texttt{plugin/commands/oracle.md}: a balance, and a minimum the balance may not
...
The Z above and the JSON of \texttt{plugin/commands/oracle.md} are the same
...
\texttt{plugin/commands/oracle.md}; it is a matter of encoding and carries no
