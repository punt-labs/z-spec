...
\begin{enumerate}[nosep,leftmargin=2.5em]
  ...
  \featureitem{B-Method support}{four commands, from \texttt{/z-spec:b-create} through \texttt{/z-spec:b-refine} --- deterministic refinement chain from spec to provably correct code. \textcolor{RiskGreen}{\textbf{Shipped (alpha).}}}\label{feat:b-method}
