...
\begin{enumerate}[nosep,leftmargin=2.5em]
  ...
  \featureitem{B-Method support}{\texttt{/z-spec:b-create}, \texttt{b-check}, \texttt{b-animate}, and \texttt{b-refine} --- deterministic refinement chain from spec to provably correct code. \textcolor{RiskGreen}{\textbf{Shipped (alpha).}}}\label{feat:b-method}
