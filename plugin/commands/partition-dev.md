...
allowed-tools: mcp__plugin_z-spec-dev_zspec__partition, mcp__plugin_z-spec-dev_zspec__show, Read, Glob, Grep, Write
---
...
Call `mcp__plugin_z-spec-dev_zspec__partition` with `file` (the spec
