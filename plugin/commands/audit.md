...
allowed-tools: mcp__plugin_z-spec_zspec__audit, mcp__plugin_z-spec_zspec__show, Read, Glob, Grep
---
...
Call `mcp__plugin_z-spec_zspec__audit` with `file` (the spec path)
