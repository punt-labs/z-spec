...
# command-not-found. /z-spec:prove looks for lean on PATH and nowhere else:
...
if command -v lean >/dev/null 2>&1; then
  ...
  echo "      /z-spec:prove will report LEAN_NOT_FOUND until you run" >&2
  echo "      source \"\$HOME/.elan/env\", or open a new shell." >&2
else
  echo "lean: not installed — skipped. Only /z-spec:prove needs it."
fi
```
