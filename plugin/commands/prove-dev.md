...
# /z-spec-dev:prove-dev - Generate Lean 4 Proof Obligations
...
`/z-spec-dev:check-dev` validates Z syntax; `/z-spec-dev:prove-dev` validates
semantic properties.

### With /z-spec-dev:partition-dev

`/z-spec-dev:partition-dev` derives test cases; `/z-spec-dev:prove-dev` derives
...
`/z-spec-dev:model2code-dev` generates implementation code.
`/z-spec-dev:prove-dev` generates formal proofs about the specification.
