...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/eb33011/install.sh | sh -s -- --no-plugin
```

Or, for argument-hostile contexts (templated CI, proxies), as an environment variable:

```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/eb33011/install.sh | ZSPEC_NO_PLUGIN=1 sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/eb33011/install.sh -o install.sh
```
