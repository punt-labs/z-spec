...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/49e9e1b/install.sh | sh
```
...
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/49e9e1b/install.sh | sh -s -- --no-plugin

# env form (for argument-hostile contexts: templated CI, proxies)
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/49e9e1b/install.sh | ZSPEC_NO_PLUGIN=1 sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/49e9e1b/install.sh -o install.sh
