...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/1c4294b/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/1c4294b/install.sh | sh -s -- --no-plugin
```

Or, for argument-hostile contexts (templated CI, proxies), as an environment variable:

```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/1c4294b/install.sh | ZSPEC_NO_PLUGIN=1 sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/z-spec/1c4294b/install.sh -o install.sh
```
