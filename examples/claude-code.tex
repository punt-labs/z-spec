...
enabled operation as a deadlock, and it cannot distinguish a machine that
has finished from one that is stuck. With the one intended halt declared,
every remaining deadlock in this specification is unintended by
construction, and finding one is finding a defect.
